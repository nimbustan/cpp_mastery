 ...
 * =============================================================================
 * EN: 1. Dangling Pointers: Pointing to an address that has already been freed. 2. Out of
 * Bounds: Reading the 10th element of a 5-element array. 3. Uninitialized Variables: Reading a
 * local variable containing garbage memory. 4. Signed Integer Overflow: Adding 1 to the absolute
 * MAX value of an `int`.
 *
 * TR: 1. Dangling (Sarkan) Pointers: Silinmiş bir adresi işaret eden pointer (Use after free).
 * 2. Sınır Aşımı (Out of Bounds): 5 elemanlı dizinin 10. elemanını okumak. 3. İlklenmemiş
 * Değişken (Uninitialized): İçine değer atanmamış çöp belleği okumak. 4. İşaretli Taşma (Signed
 * Overflow): Maksimum sınırındaki int değerine 1 eklemek (C++'ta UB'dir).
 *
 * =============================================================================
