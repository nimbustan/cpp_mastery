 ...
 *
 * TR:
 *   1. Kalıtım (Inheritance) -> Kod tekrarını önler (DRY).
 *   2. Çok Biçimlilik (Polymorphism) -> V-Table ile dinamik esneklik sağlar.
 *   3. Kapsülleme (Encapsulation) -> Veri gizleme ve güvenlik kalkanıdır.
 *   4. Soyutlama (Abstraction) -> Sadece "Neyin" yapılacağını gösterir, "Nasıl" yapıldığını
 *      gizler.
 *
 * =============================================================================
