 ...
 *
 * TR: Modern CPU'lar her okuma/yazma için doğrudan ana belleğe (RAM) erişmez.
 *     Bunun yerine, çekirdek ile RAM arasında küçük ve hızlı önbellekler bulunur:
 *     1. L1 önbellek — çekirdek başına, ~32-64 KB, ~1-4 döngü gecikme.
 *     2. L2 önbellek — çekirdek başına, ~256 KB-1 MB, ~10-20 döngü.
 *     3. L3 önbellek — çekirdekler arası paylaşımlı, ~4-64 MB, ~30-50 döngü.
 *     4. Ana RAM     — ~100-300 döngü gecikme.
 *     Veriler önbellek satırları halinde, genellikle 64 bayt olarak aktarılır.
 *
 * =============================================================================
