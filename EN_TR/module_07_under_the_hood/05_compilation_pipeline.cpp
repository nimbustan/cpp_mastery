 ...
 * @details
 * =====================================================================
 * [THEORY: C++ Compilation Pipeline / TEORİ: C++ Derleme Hattı]
 * =====================================================================
 *
 ...
 *
 * ── Aşama 1: ÖN İŞLEME ── Ön işlemci (cpp), gerçek derlemeden önce çalışır:
 * • #include — başlık dosyalarının metin olarak dahil edilmesi
 * • #define / #ifdef / #ifndef — makro açılımı ve koşullu derleme
 * • #pragma — derleyiciye özel direktifler
 * • __FILE__, __LINE__, __func__ — önceden tanımlı makrolar
 * Otomotivde koşullu derleme, tek kod tabanından donanıma özel yolları seçer.
 *
 * ── Aşama 2: DERLEME ── Derleyici, ön işlenmiş her çeviri birimini (TU) nesne dosyasına
 ...
 * açabilir.
 *
 * ── Aşama 3: BAĞLAMA ── Bağlayıcı (ld), nesne dosyalarını birleştirir ve sembol
 ...
 * bağlantı sağlar.
 *
 * ── Aşama 4: YÜKLEME ── İşletim sistemi yükleyicisi çalıştırılabilir dosyayı belleğe eşler,
 ...
 *
 * ── Başlık-Yalnız Kütüphaneler ── Tüm kodu başlık dosyalarına koymak pratiktir ancak
