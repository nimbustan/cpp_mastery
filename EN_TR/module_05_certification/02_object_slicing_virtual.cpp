 ...
 *
 * TR: C++'ta nesneler RAM'de yan yana duran kutucuklardır.
 * - Base Sınıf: 4 Bayt (sadece yaş)
 * - Derived Sınıf: 8 Bayt (hem yaş hem maaş)
 * Eğer `Base b = Derived();` derseniz, derleyici 4
