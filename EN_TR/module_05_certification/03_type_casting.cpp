 ...
 * 1. static_cast<Type>(val)
 * ─────────────────────────────────────────────────────────────────────────────
 * "Mantıklı/ideal" dönüşüm. float → int, int → enum, base* → derived* gibi iyi tanımlanmış
 ...
 * 2. dynamic_cast<Type>(val)
 * ─────────────────────────────────────────────────────────────────────────────
 * "Güvenli polimorfizm" dönüşümü. Üst sınıf pointer/referansını alt sınıfa güvenle
 ...
 * 3. const_cast<Type>(val)
 * ─────────────────────────────────────────────────────────────────────────────
 * `const` veya `volatile` niteleyicilerini kaldırır. SADECE `const` parametreyi unutmuş eski
 ...
 * 4. reinterpret_cast<Type>(val)
 * ─────────────────────────────────────────────────────────────────────────────
 * "Kaba kuvvet" dönüşümü. Bir tipin ham bit desenini başka bir tip olarak yorumlar. Kontrol
