 ...
 * @brief OTA (Over-The-Air) Update Mechanism
 *
 * @details
 * =============================================================================
 * [THEORY: OTA Update Lifecycle]
 * =============================================================================
 *
 ...
 *
 * =============================================================================
 * [THEORY: A/B Partitioning — Atomic Slot Swap]
 * =============================================================================
 *
 ...
 *
 * =============================================================================
 * [THEORY: UDS Flash Programming Sequence]
 * =============================================================================
 *
...
struct FirmwareHeader {
    ...
    uint32_t header_crc32;      // CRC of header fields (excluding this field)
    uint64_t timestamp;         // build timestamp (epoch)
    char     target_ecu[16];    // target ECU identifier
...
struct PartitionInfo {
    ...
    uint32_t fw_crc32 = 0;
    bool     valid = false;
    bool     confirmed = false;    // EN: set after successful boot
