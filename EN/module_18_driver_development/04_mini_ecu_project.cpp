 ...
 * @details
 * =============================================================================
 * [THEORY: BCM (Body Control Module) Architecture]
 * =============================================================================
 *
...
struct LIN_Frame {
    uint8_t pid = 0;       // Protected identifier
    uint8_t length = 0;
    std::array<uint8_t, 8> data{};
...
public:
    ...
    UDS_Response Process(const UDS_Request& req, DTCStore& dtcs, NvMStore& nvm,
        ...
        switch (req.sid) {
            ...
            default:
                return {req.sid, false, 0x11, {}};  // serviceNotSupported
        }
    }
...
private:
    UDS_Response HandleReadDID(const UDS_Request& req, NvMStore& nvm,
        ...
        switch (req.param) {
            ...
            default:
                return {req.sid, false, 0x31, {}};  // requestOutOfRange
        }
    }
