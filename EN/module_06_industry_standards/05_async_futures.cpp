 ...
 * @details
 * =============================================================================
 * [THEORY: Why std::async instead of std::thread?]
 * =============================================================================
 ...
 *
 * =============================================================================
 * [THEORY: std::promise — The Manual Push Channel]
 * =============================================================================
 ...
 *
 * =============================================================================
 * [THEORY: std::packaged_task — Callable Wrapper with Future]
 * =============================================================================
 ...
 *
 * =============================================================================
 * [THEORY: std::shared_future — Multiple Readers]
 * =============================================================================
 ...
 *
 * =============================================================================
 * [CPPREF DEPTH: The Silent Block of `std::future` Destructor]
 * =============================================================================
 ...
 *
 * =============================================================================
 * [CPPREF DEPTH: std::promise::set_exception — Error Propagation Across Threads]
 * =============================================================================
 ...
 *
 * =============================================================================
 * [CPPREF DEPTH: std::packaged_task is MoveOnly — No Copying!]
 * =============================================================================
...
int heavyServerRequest() {
  std::cout << "[WORKER THREAD] Accessing Server... ETA: 3 Seconds"
            << std::endl;
  std::this_thread::sleep_for(std::chrono::seconds(3));

  std::cout << "[WORKER THREAD] Server Responded: [OK - 200]" << std::endl;
...
// ═════════════════════════════════════════════════════════════════════════════════════════════════
// [DEMO 2: std::promise - Manual Value Push]
// ═════════════════════════════════════════════════════════════════════════════════════════════════
/**
...
// ═════════════════════════════════════════════════════════════════════════════════════════════════
// [DEMO 3: std::packaged_task - Deferred Callable]
// ═════════════════════════════════════════════════════════════════════════════════════════════════
/**
...
int main() {
  ...
  for (int i = 1; i <= 3; i++) {
    std::cout << "[MAIN] Drawing Frame " << i << std::endl;
    std::this_thread::sleep_for(std::chrono::seconds(1));
  }
  ...
  std::cout << "Received Server Code: " << result << std::endl;
