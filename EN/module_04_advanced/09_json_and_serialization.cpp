 ...
 * @brief JSON & Serialization: Data Serialization & JSON Processing
 *
 * @details
 * =============================================================================
 * [THEORY: What Is Serialization?]
 * =============================================================================
 *
 ...
 *
 * =============================================================================
 * [THEORY: Binary Serialization Pitfalls]
 * =============================================================================
 *
...
public:
    ...
    void write_u16(uint16_t val) {
        buffer_.push_back(static_cast<uint8_t>(val & 0xFF));         // EN: LSB
        buffer_.push_back(static_cast<uint8_t>((val >> 8) & 0xFF));  // EN: MSB
    }
