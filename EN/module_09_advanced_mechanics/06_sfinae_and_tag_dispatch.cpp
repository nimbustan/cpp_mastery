 ...
 * @brief SFINAE, Tag Dispatch & if constexpr
 ...
 *
 * [CPPREF DEPTH: SFINAE Contexts and the Expression SFINAE Revolution]
 * =============================================================================
 ...
 *
 *
 * @note Compile: g++ -std=c++20 -Wall -Wextra -Wpedantic -Wshadow -Wconversion 06_sfinae_and_tag_dispatch.cpp -o 06_sfinae_and_tag_dispatch
 * @date 2026
