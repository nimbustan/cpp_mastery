 ...
 * This file provides: (1) anti-pattern warnings, (2) head-to-head comparisons between confusing
 * pairs, (3) before/after refactoring examples, and (4) two missing patterns: Proxy and Prototype.
 *
 ...
 * seçeceğinizi bilmektir. Bu dosya şunları sunar: (1) anti-pattern uyarıları, (2) kafa
 * karıştıran çiftler arası karşılaştırmalar, (3) öncesi/sonrası refactoring örnekleri ve
