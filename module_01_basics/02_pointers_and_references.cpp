 ...
 * =============================================================================
 * EN: 1. POINTER (*): Inherited from C. Can be NULL/nullptr. Flexible, can be REASSIGNED to
 * point to another object during runtime. Can be dangerous. 2. REFERENCE (&): Introduced in C++.
 * CAN NEVER be NULL (Must be initialized when declared). Safer and cleaner syntax. Once
 * initialized, it gets LOCKED and cannot point to anything else.
 *
 * TR: 1. POINTER (*): C dilinden kalmadır. NULL/nullptr olabilir. Esnektir, çalışırken başka bir
 * nesneyi gösterecek şekilde DEĞİŞTİRİLEBİLİR. Tehlikeli olabilir. 2. REFERENCE (&): C++ ile
 * gelmiştir. ASLA NULL olamaz (Tanımlandığı an bir hedefi olmalıdır). Daha güvenli ve temiz bir
 * sözdizimi vardır. Oluşturulduktan sonra BAŞKA bir şeyi gösteremez, tamamen kilitlenir.
 *
 * =============================================================================
