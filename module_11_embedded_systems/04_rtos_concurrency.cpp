 ...
 * Solutions: (1) Priority Inheritance: temporarily boost the low-priority task's priority. (2)
 * Priority Ceiling: mutex has a pre-assigned ceiling priority. (3) Lock-free structures:
 * eliminate mutexes entirely.
 *
 * TR: Öncelik Tersine Çevrilmesi, yüksek öncelikli görev paylaşılan bir mutex'i tutan düşük
 * öncelikli görevi beklediğinde oluşur — orta öncelikli görev düşük öncelikliyi keserken, yüksek
 * öncelikli görevi SÜRESİZ BLOKE EDİYOR. Bu, 1997'de Mars Pathfinder yeniden başlatma döngüsüne
 * neden oldu. Çözümler: (1) Öncelik Kalıtımı: düşük öncelikli görevin önceliğini geçici olarak
 * yükselt. (2) Öncelik Tavanı: mutex'in önceden atanmış bir tavan önceliği vardır. (3) Kilitsiz
 * yapılar: mutex'leri tamamen ortadan kaldır.
 *
 * =============================================================================
