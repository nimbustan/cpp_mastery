 ...
 * @details
 * =============================================================================
 * [THEORY: Why does the Rule of 0 / 3 / 5 exist? (Shallow Copy Crisis)]
 * =============================================================================
 * EN: When you create a basic Class, the C++ compiler automatically generates 3 things for you:
 * 1. A default Destructor 2. A default Copy Constructor (Sensor s2 = s1;) 3. A default Copy
 * Assignment Operator (p2 = p1;)
 *
 ...
 * Free" and crash!
 *
 * TR: Temel bir sınıf yazdığınızda, C++ derleyicisi otomatik olarak 3 şey üretir: 1. Varsayılan
 * Yıkıcı (Destructor) 2. Varsayılan Kopya Yapıcı (Copy Constructor) (Sensor s2 = s1;) 3.
 * Varsayılan Kopya Atama Operatörü (Copy Assignment) (p2 = p1;)
 *
 ...
 *
 * 1. Yıkıcı (Destructor) 2. Kopya Yapıcı (Copy Constructor) 3. Kopya Atama Operatörü (Copy
 * Assignment Operator)
 *
 * =============================================================================
